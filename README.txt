...
To execute the server as an executable follow these steps :
--- chmod +x Simple_ftp_server.py
--- ./Simple_ftp_server.py 7738 test_file.txt 0.1
...
To execute the client as an executable follow these steps :
--- chmod +x Simple_ftp_client.py
--- ./Simple_ftp_client.py 127.0.0.1 7738 sample-2mb-text-file.txt 10 500
